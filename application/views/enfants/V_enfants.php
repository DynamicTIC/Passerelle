...
<div class="student-group-form" id="container_view">
<div class="row">
...
<a href="teacher-details.html" class="avatar avatar-sm me-2"><img class="avatar-img rounded-circle" src="<?php echo base_url()?>assets/img/profiles/avatar-02.jpg" alt="User Image"></a>
