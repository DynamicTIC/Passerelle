                ...
                <div class="loginbox">
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form action="<?= base_url('auth/passeword') ?>" method="post">
                                <div class="form-group">
                                <?php $email=$_POST['email'];?>
                                    <label>Mot de passe <span class="login-danger">*</span></label>
                                    <input class="form-control" placeholder="Email" type="hidden" name="email" value="<?php echo $email;?>"
                                            required>
                                    <input class="form-control pass-input" placeholder="mot de passe" type="password"
